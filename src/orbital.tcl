...
#  Jul 08, 2019 09:07:22 PM IST  platform: Linux
set vTcl(timestamp) ""
...
proc vTclWindow.top42 {base} {
    ...
    wm deiconify $top
    wm title $top "Orbital Volume"
    vTcl:DefineAlias "$top" "orbital" vTcl:Toplevel:WidgetProc "" 1
    ...
    $site_3_0.men44 add cascade \
        -menu "$site_3_0.men44.men45" -activebackground {#ececec} \
        -activeforeground {#000000} -background {#d9d9d9} -font TkMenuFont \
        -foreground {#000000} -label {Open Dir} 
